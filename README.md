...
or company being paid, before the payment goes out. Sweden even has the natural operator:
Bankgirocentralen already maps bankgiro numbers to owners (its public number search proves
it), but coverage stops at bankgiro aliases. Accounts and IBANs, the space the headline
attack lives in, have no registry and no API, and IMY's regulatory sandbox with SEB,
Nordea, Swedbank and Handelsbanken concluded that account-level sharing between banks
needs legislative change (IMY-2024-14275, May 2025). The demo shows what the day after
that legislation looks like, with Bankgirocentralen as the obvious operator.
